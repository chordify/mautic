...
return [
    ...
    'routes' => [
        ...
        'api' => [
            ...
            'mautic_api_websitenotifications_inbox_set_read_many' => [
                'path'       => '/website_notifications/inbox/{leadId}/read',
                'controller' => 'WebsiteNotificationsBundle:Api\WebsiteNotificationsApi:inboxSetReadMany',
                'method'     => 'POST',
            ],
